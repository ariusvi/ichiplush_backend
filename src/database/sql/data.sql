...
insert into users (id, user_name, role_id, password, email, is_active) values (1, 'super_admin', 1, '$08$cISKK0HLqPO/bpG5jdMtpuaghTzDqkGv1FkdzJERbmFLZaTtJ4LNW', 'superadmin@email.com', 1);
